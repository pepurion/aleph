...
Upon reaching **0 DHP** a character enters **coma** and is on death's door. For more info - [[Miscellaneous#Dying *(Not Advised)*|Dying]].
...
You have a limited amount of inventory space based on **slots**. Every creature has a slot **limit** based on their **Strength** score multiplied by their [[Miscellaneous#Size Categories|size]] (ex. Medium is x5). Many items may need more than 1 slot to carry them. Currency and augments **do not** use slots.
